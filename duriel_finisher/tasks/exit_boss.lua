...
local task = {
    ...
    shouldExecute = function()
        ...
        if utils.match_player_zone("Boss_WT4_") or utils.match_player_zone("Boss_WT3_") then
    ...
    Execute = function()
      ...
      --  console.print("Clearing path and target in explorer.")
        ...
        if not utils.match_player_zone("Boss_WT4_") or not utils.match_player_zone("Boss_WT3_") then
